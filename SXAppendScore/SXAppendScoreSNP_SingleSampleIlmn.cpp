...
void ProcessRecs()
{
    ...
    {        
        ...
        fAQSScore = (fAvgQS < 15.00)?0:(fAvgQS-15.00)*(100.00/25.00); //Denomitor = 40 (Max.)-15
        //fSNPScore = (fPEScore+fSNPReadScore+fStrandScore+fReadDenScore+(float)nReptDenScore+fAQSScore)/520.00;
        
        fPEScore = 0.00; 
        fSNPScore = (fSNPReadScore+fStrandScore+fReadDenScore+(float)nReptDenScore+fAQSScore)/420.00;
