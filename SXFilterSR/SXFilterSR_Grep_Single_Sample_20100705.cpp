...
int main(int argc, char** argv) {
    ...
    if (argc < 4)
    {
        ...
        fprintf(stdout,"\t<Input filename> <Output filename 1> <Output filename 2> <Min. Supporting Reads> \n");
        exit(9);
    }
    ...
    char acbuf[1024],acOut[1024]; char *pChr=NULL; int nSR=0;
    ...
    while (!feof(pfIn))
    {
        ...
        pChr = strtok(acbuf,"\t"); pChr = strtok(NULL,"\t");
