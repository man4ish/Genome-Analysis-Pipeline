...
void ProcessRecs()
{
    int nOffset,nTotalSNPCnt,nTotalReadDens,nReadStrength;
    ...
    while(!feof(g_pfIn))
    {
        ...
        */
        ...
        nReadStrength = (int)((double)(nTotalSNPCnt*100)/(double)(nTotalReadDens));//+0.5);
...
int main(int argc, char** argv) {
    ...
    */
    ...
    g_pfOut = fopen(argv[8],"w");
    if (!g_pfOut){
        fprintf(stdout,"Failed to open %s ...\n",argv[8]); goto Err_Exit;
    }
