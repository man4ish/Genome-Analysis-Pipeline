...
public:
    ...
    bool OutputMNVINDELNovel(int chrno, size_t offset,const char *pcVariant, FILE* pf, char acRsid[]);
    void ClrDBINDELMap();
...
private:
    ...
    bool matchMNVINDEL(const char *pcAllele, int nAlleleLen, const char orient,const char* db);
    ...
    bool MapMNVAllele( Key* location ,const char *pcVariant, char acRsid[]);
