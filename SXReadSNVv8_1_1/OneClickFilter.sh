...
time $PRG $SAMPLE1_SAMPLE2_NOVEL_COMMON $M_MIN_NSR $M_MIN_NRS $M_MIN_NRD $SAMPLE1_SAMPLE2_NOVEL_COMMON"_f1"
...
time $PRG $SAMPLE2_NOVEL_UNIQUE $M_MIN_NSR $M_MIN_NRS $M_MIN_NRD $SAMPLE2_NOVEL_UNIQUE"_f1"
