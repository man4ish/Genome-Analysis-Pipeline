...
echo $PRG $SAMPLE1_SAMPLE2_NOVEL_COMMON"_f2 >" $SAMPLE1_SAMPLE2_NOVEL_COMMON"_f3"
eval time $PRG $SAMPLE1_SAMPLE2_NOVEL_COMMON"_f2 >" $SAMPLE1_SAMPLE2_NOVEL_COMMON"_f3"
...
echo $PRG $SAMPLE1_NOVEL_UNIQUE"_f2 >" $SAMPLE1_NOVEL_UNIQUE"_f3"
eval time $PRG $SAMPLE1_NOVEL_UNIQUE"_f2 >" $SAMPLE1_NOVEL_UNIQUE"_f3"
...
echo $PRG $SAMPLE2_NOVEL_UNIQUE"_f2 >" $SAMPLE2_NOVEL_UNIQUE"_f3"
eval time $PRG $SAMPLE2_NOVEL_UNIQUE"_f2 >" $SAMPLE2_NOVEL_UNIQUE"_f3"
