...
{   
    printf("Synamatix SXAppendScoreDEL_Ilmn_B4Annotation Copyright 2010 Synamatix Sdn Bhd\n");
    printf("Built %s %s\n", __DATE__, __TIME__);
    printf("Usage: %s\n", argv[0]);
...
void ProcessRecs()
{
    ...
    float fFwdSNPCnt,fRvsSNPCnt,fStrandScore,fStrandRatio;  
    ...
    {        
        ...
        pChr = strtok(acbuf,"\t"); //Chromosome,GiNumber
