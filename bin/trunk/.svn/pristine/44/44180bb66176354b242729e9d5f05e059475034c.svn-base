...
FDBINDEL=$M_REFDIR"/dbINDEL_131" #$M_GENOME
HSREF="hs_ref_37.1"
#------------------------------------------------------------------------------------------------
...
echo $PRG "-f" $1 "-gLa" $FDBSNP $FDBINDEL $READSDIR "1 10000 0 0" $2 $M_GENOME "33" $HSREF
#time $PRG -f $1 -gLa $FDBSNP $FDBINDEL $READSDIR 1 10000 0 0 $2 $M_GENOME "33" $HSREF


READSDIR=$M_APPDIR"/GS000117/37_1_"$4"/raw_read"
echo $PRG "-f" $3 "-gLa" $FDBSNP $FDBINDEL $READSDIR "1 10000 0 0" $4 $M_GENOME 33 $HSREF
#time $PRG -f $3 -gLa $FDBSNP $FDBINDEL $READSDIR 1 10000 0 0 $4 $M_GENOME 33 $HSREF
