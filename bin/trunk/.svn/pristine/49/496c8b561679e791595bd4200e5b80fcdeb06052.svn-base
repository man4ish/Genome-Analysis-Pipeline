...
*/
        ...
        pChr = strtok(NULL,"\t");
        nMappableReptDens = atoi(pChr);//Mappable_Repeat_Densities
        ...
        fSNPScore = ((float)nPEScore+(float)nSNPReadScore+(float)nStrandScore+fReadDenScore+(float)nReptDenScore+fAQSScore)/520.00;
