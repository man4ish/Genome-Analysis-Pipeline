...
PRG=$M_APPDIR"/SXPrintZygosityCNV/./SXPrintCNVEx"

echo ""
echo $PRG $FILE_INPUT"_Zygo" $M_MEAN $READSDIR $REPTDENDIR $M_MASKDENSDIR $M_SAMPLEID $FILE_INPUT"_ZygoCNV"
time $PRG $FILE_INPUT"_Zygo" $M_MEAN $READSDIR $REPTDENDIR $M_MASKDENSDIR $M_SAMPLEID $FILE_INPUT"_ZygoCNV"
...
SUMMARY_RPT=$M_SAMPLEID"_"$SNAME"_summary_c1_"$CURR_DATE".rpt"
SUMMARY_ORI=$M_SAMPLEID"_"$SNAME"_summary_c1_"$CURR_DATE".rpt.ori"
