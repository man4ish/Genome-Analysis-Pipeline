        ...
        */  
        ...
        else if (m_pSNVClustered[i].cRefBase =='-' )
        {
            if (bINS1){
                ...
                if (ChkPoly_INS.unOffset!=m_pSNVClustered[i].unOffset) m_pSNVClustered[i].bKeep = true;
            ...
            { 
               ...
               m_pSNVClustered[ChkPoly_INS.ulIdx].bKeep = true; 
            ...
            //fprintf(pfPDenINS,"\t%u\t%u\t%u\n",ChkPoly_INS.unOffset,
            //                  ChkPoly_INS.unPDensity+m_pSNVClustered[ChkPoly_INS.ulIdx].unCnt,
            //                  m_pSNVClustered[ChkPoly_INS.ulIdx].unCnt);
...
EndINS:
	    ...
	    if (bDEL1){
                ...
                m_pSNVClustered[i].cRefBase==m_pSNVClustered[ChkPoly_DEL.ulIdx].cRefBase)
            {
               ...
               {
//if (m_pSNVClustered[i].cChromosome==1 && (m_pSNVClustered[i].unOffset==825942||m_pSNVClustered[i].unOffset==825943))
//{ fprintf(pfPolyINS,"~~~~~~1\t%u\t%u ~~~~~~~~~~~~~\n",m_pSNVClustered[i].unOffset,m_pSNVClustered[i].unCnt);}
...
ProcLastDELRec:
    ...
    //fprintf(pfPDenDEL,"\t%u\t%u\t%u\n",ChkPoly_DEL.unOffset,
    //                   ChkPoly_DEL.unPDensity + m_pSNVClustered[ChkPoly_DEL.ulIdx].unCnt,
    //                   m_pSNVClustered[ChkPoly_DEL.ulIdx].unCnt);
