...
FDBINS=$M_REFDIR"/dbINS_131_v1" #$M_GENOME
...
echo $PRG "-f" $1 "-gLa" $FDBSNP $FDBINS $FDBDEL $READSDIR "1 100000 0 0" $2 $M_GENOME "33" $M_HSREF
...
echo $PRG "-f" $3 "-gLa" $FDBSNP $FDBINS $FDBDEL $READSDIR "1 100000 0 0" $4 $M_GENOME "33" $M_HSREF
#time $PRG -f $3 -gLa $FDBSNP $FDBINS $FDBDEL $READSDIR 1 100000 0 0 $4 $M_GENOME 33 $M_HSREF
...
#. $M_APPDIR"/SXReadSNVvPoly2_dbSNP131/TestScript/OneClickFilter_IS.sh"
...
#. $M_APPDIR"/SXReadSNVvPoly2_dbSNP131/TestScript/MergePoly.sh"
...
. $M_APPDIR"/SXReadSNVvPoly2_dbSNP131/TestScript/SplitCloseVicinitySNV.sh"
...
#. $M_APPDIR"/SXReadSNVvPoly2_dbSNP131/TestScript/OneClickAnnotate_IS_SNP.sh"
...
M_MIN_KSR=3           #Min. Known Supporting Reads
M_MIN_NSR=3           #Min. Novel Supporting Reads               
M_MIN_NRD=3

M_MIN_KSR2=4           #Min. Known Supporting Reads
M_MIN_NSR2=4           #Min. Novel Supporting Reads               
M_MIN_NRD2=4
...
. $M_APPDIR"/SXReadSNVvPoly2_dbSNP131/TestScript/OneClickAnnotate_IS.sh"
...
M_MIN_KSR=5           #Min. Known Supporting Reads
M_MIN_NSR=5           #Min. Novel Supporting Reads               
M_MIN_NRD=5

M_MIN_KSR2=5           #Min. Known Supporting Reads
M_MIN_NSR2=5           #Min. Novel Supporting Reads               
M_MIN_NRD2=5
