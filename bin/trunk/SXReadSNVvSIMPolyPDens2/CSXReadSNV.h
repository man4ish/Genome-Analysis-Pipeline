...
private:
    ...
    int CheckPoly(int nChroIdx, unsigned int nOffset, char cAllele, eSNVType eSNV, FILE *pf, unsigned int unCnt);
    ...
    bool SearchClusteredList(unsigned long ulStart,unsigned long ulEnd, unsigned int unOffset, unsigned long &ulFound);
