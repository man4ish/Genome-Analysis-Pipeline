...
{   
    ...
    while (!feof(pfSrc))
    {
        ...
        /*else if(nTotalTabs == 7||nTotalTabs == 8){
            pChr = strtok(NULL,"\t"); ulOffset = atol(pChr); //Offset
...
*/    
    ...
    for (unsigned long i=0; i<m_ulTotalRecs; i++)
    {                
        if (m_pSNV[i].cRefBase == m_pSNV[i].cVarBase) {fprintf(pfVRI,"%lu\n",i); continue;}
    ...
    if ((cRefBase_Curr!='A' && cRefBase_Curr!='C' && cRefBase_Curr!='G' && cRefBase_Curr!='T' && 
         ...
         cVarBase_Curr!='T' && cVarBase_Curr!='T'))
    {
   ...
   for (int i=0; i < 24; i++)
   {
       ...
       {   
          ...
          {
              ulTest2++;
              fprintf(stdout,"Total Recs gone through clustering = %luM\n", ulTest2);
              ulTest1=0;
          }
       }
    }
...
///////
    ...
    for (unsigned long i=0; i < merge_list_used; i++)
    {
        ...
        {
            ulTest2++;
            fprintf(stdout,"Total Clustered Recs Processed = %luM\n", ulTest2);
            ulTest1=0;
        }
